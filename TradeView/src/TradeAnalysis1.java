...
public class TradeAnalysis1 {
	TradeReader1 TR1;


	public TradeAnalysis1() {
		this.TR1 =  new TradeReader1("trades3.csv");
	...
	public static void main(String[] args) {
		...
		TradeAnalysis1 TA1 = new TradeAnalysis1();
		TA1.allTrades();
		//TA.distinctTickers();
		...
		TA1.pnlTotalClosed(TA1.distinctTickers());
		TA1.openPositions(TA1.distinctTickers());
